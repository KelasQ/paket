                                    ...
                                    <tr id="delete<?= $row->id; ?>">
                                        ...
                                        <td>
                                            ...
                                            <div class="table-actions text-center">
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-success btn-icon text-white btn-paket-publish" data-id="<?php echo $row->id; ?>" data-publish="<?php echo $publishData; ?>" data-no_invoice="<?php echo $row->no_invoice; ?>">
