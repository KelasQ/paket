                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php echo form_open_multipart('paket/filterby');?>
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputName1">Username</label><br>
                                                <select class="js-sup" name="username">
                                                    <option></option>
                                                    <option value='all'>All User</option>
                                        <?php foreach ($username as $row) : ?>
                                                    <option value="<?=$row->username?>"><?=$row->username?></option><?php endforeach ?>
                                                </select>
                                            </div>
