            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?> -->
                        <?= form_open('timeline/update/' . $dataTimeline['id_timeline']); ?>
                        <input type="hidden" name="id_timeline" id="id_timeline" value="<?= $dataTimeline['id_timeline']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="no_invoice" id="no_invoice" class="form-control invoices" required>
                                <option value="<?= $dataTimeline['no_invoice']; ?>"><?= $dataTimeline['no_invoice']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" id="keterangan" cols="30" rows="3" placeholder="Keterangan" class="form-control" required><?= $dataTimeline['keterangan']; ?></textarea>
                        </div>
